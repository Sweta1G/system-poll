...
export default function TeacherPage() {
  ...
  const [forceShowCreation, setForceShowCreation] = useState(false);
  ...
  const startPoll = () => {
    ...
    // Reset force flag when starting new poll
    setForceShowCreation(false);
  ...
  const startNewQuestion = () => {
    ...
    // Force show creation form immediately
    setForceShowCreation(true);
  ...
  // Show results page when poll is active or in results phase, unless forced to show creation
  if ((state.phase === "active" || state.phase === "results") && !forceShowCreation) {
    return (
      <AppLayout>
          ...
          <div className="flex flex-col items-center space-y-2">
            ...
            <div className="flex gap-3 justify-center">
              <button
                ...
                className="inline-flex items-center gap-2 rounded-full bg-primary px-6 py-3 text-primary-foreground font-medium disabled:opacity-50 disabled:cursor-not-allowed hover:opacity-90"
              >
                + Ask a new question
              </button>
              <a 
                href="/history" 
                className="inline-flex items-center gap-2 rounded-full bg-primary/90 text-primary-foreground px-6 py-3 font-medium hover:opacity-90"
              >
                👁 View Poll History
              </a>
            </div>
