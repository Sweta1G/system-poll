...
export default function Student() {
  ...
  useEffect(() => {
    ...
    const handlePollUpdate = (state: any) => {
      console.log('Student poll update received:', { phase: state.phase, hasVoted: state.hasVoted, votes: state.votes, submissions: state.submissions });
      ...
      if (state.phase === 'active') {
        ...
        // Update live vote data - ensure we have the latest from server
        ...
        // Use server's hasVoted status and sync with local state
        const serverHasVoted = state.hasVoted || false;
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              ...
              <div className="p-6 space-y-4">
                {currentPoll.options.map((opt: string, i: number) => {
                  ...
                  console.log(`Option ${i}: votes=${votes}, total=${total}, pct=${pct}%`);
