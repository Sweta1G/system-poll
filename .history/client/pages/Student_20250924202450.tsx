...
export default function Student() {
  ...
  const handleJoinSession = (e: React.FormEvent) => {
    e.preventDefault();
    console.log('Attempting to join with name:', studentName);
    if (studentName.trim()) {
      const socket = getSocket();
      console.log('Emitting student:join with:', studentName.trim());
      socket.emit('student:join', studentName.trim());
      // Force the component to recognize that the student has joined
      // The server should acknowledge this, but we'll set it locally too
    }
  };
