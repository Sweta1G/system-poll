import { useState } from 'react';import { useEffect, useState } from 'react';import { useEffect, useState } from 'react';import { useEffect, useState } from 'react';
...
export default function Student() {
  ...
  const [studentName, setStudentName] = useState('');import AppLayout from '../components/AppLayout';import { getSocket } from '../lib/socket';import { getSocket } from '../lib/socket';
  ...
  return (
    ...
    <AppLayout>
      ...
      <div className="max-w-md mx-auto mt-20">export default function Student() {import AppLayout from '../components/AppLayout';import AppLayout from '../components/AppLayout';

        <h1 className="text-2xl font-bold mb-4">Student Poll</h1>

        <p className="text-gray-600">Simple student interface</p>  const [studentName, setStudentName] = useState('');

      </div>

    </AppLayout>  const [currentPoll, setCurrentPoll] = useState<any>(null);
