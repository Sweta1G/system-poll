...
export default function Student() {
  ...
  // Show live poll results for students who have voted (same as teacher view)
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              ...
              <div className="p-6 space-y-4">
                {currentPoll.options.map((opt: string, i: number) => {
                  // We need to get the current vote data from socket updates
                  // For now, we'll show the basic structure and add vote tracking
                  const total = Math.max(1, 1); // Placeholder - will be updated by socket
                  const votes = 0; // Placeholder - will be updated by socket  
                  const pct = 0; // Placeholder - will be updated by socket
              ...
              <div className="p-6 pt-0">
                <div className="text-center text-gray-600 bg-blue-50 border border-blue-200 rounded-lg p-4">
                  ...
                  <div className="text-sm text-blue-600">Live results updating as other students vote...</div>
                </div>
              </div>
            </div>
          </div>
