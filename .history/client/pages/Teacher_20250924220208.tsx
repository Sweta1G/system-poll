...
export default function TeacherPage() {
  ...
  const canAskNewQuestion = state.phase === "results" || (state.participants > 0 && state.submissions >= state.participants);
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="flex justify-center">
            <button
              ...
              className="inline-flex items-center gap-2 rounded-full bg-primary px-6 py-3 text-primary-foreground font-medium disabled:opacity-50 disabled:cursor-not-allowed"
            >
              + Ask a new question
            </button>
          </div>
