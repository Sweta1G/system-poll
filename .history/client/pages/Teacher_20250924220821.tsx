...
export default function TeacherPage() {
  ...
  const canAskNewQuestion = true; // Force enable for debugging - will fix logic after
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="flex flex-col items-center space-y-2">
            <div className="text-sm text-muted-foreground">
              ...
              {canAskNewQuestion && <span className="text-green-600 ml-2">✓ Ready</span>}
            </div>
            <button
            ...
            <div className="text-xs text-gray-400">
              Debug: Phase={state.phase}, All answered={allAnswered}
            </div>
          </div>
        </div>
