...
export default function Student() {
  ...
  useEffect(() => {
    ...
    function onPollEnded(result: PollResult) {
      setCurrentPoll(null);
    ...
    function onKicked(data: { reason?: string }) {
      setIsKicked(true);
      setKickReason(data.reason || 'You have been removed from the session');
      setCurrentPoll(null);
      setPollResult(null);
    }
